...
import { TabId } from '../../constants/routes';
...
const tabs = [
  { id: 'HOME' as TabId, label: 'INICIO', color: 'bg-[#b4ff6f]', hoverColor: 'hover:bg-[#b4ff6f]' },
  { id: 'AGENDA' as TabId, label: 'AGENDA', color: 'bg-[#ff7e67]', hoverColor: 'hover:bg-[#ff7e67]' },
  { id: 'GREEN_AREAS' as TabId, label: 'ÁREAS VERDES', color: 'bg-[#fccb4e]', hoverColor: 'hover:bg-[#fccb4e]' },
  { id: 'NEWSLETTERS' as TabId, label: 'BOLETINES', color: 'bg-[#ff9d9d]', hoverColor: 'hover:bg-[#ff9d9d]' },
  { id: 'GAZETTES' as TabId, label: 'GACETAS', color: 'bg-[#9dcdff]', hoverColor: 'hover:bg-[#9dcdff]' },
  { id: 'PARTICIPATION' as TabId, label: 'PARTICIPACIÓN', color: 'bg-[#d89dff]', hoverColor: 'hover:bg-[#d89dff]' },
];
