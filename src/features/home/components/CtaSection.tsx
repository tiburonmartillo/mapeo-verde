    ...
    <section className="bg-[#b4ff6f] text-black py-16 px-4 sm:px-6 md:py-32 border-b border-black text-center overflow-x-hidden">
      <div className="max-w-5xl mx-auto">
        <div className="mb-6 md:mb-8 inline-block">
          <p className="font-mono text-xs uppercase tracking-widest border border-black bg-white px-3 py-1">Acción</p>
        </div>
      ...
      <div className="w-full max-w-full">
        <button
          className="w-full px-4 sm:px-8 py-4 sm:py-5 bg-black text-white text-2xl sm:text-4xl md:text-6xl font-bold hover:bg-[#ff7e67] transition-all active:translate-y-1 rounded-full leading-tight"
