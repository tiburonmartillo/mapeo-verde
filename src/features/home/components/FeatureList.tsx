  ...
  return (
    <section className="bg-[#0a0a0a] text-white py-14 px-4 sm:px-6 md:py-24 border-b border-white/20">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 md:mb-12 border border-white bg-black px-3 py-1 inline-block">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-[120px_1fr_auto] items-start md:items-center gap-4 sm:gap-6 p-5 sm:p-8 md:p-10">
                  <div className="flex items-center gap-4">
                    <span className={`inline-flex h-12 w-12 items-center justify-center border-2 border-black ${f.accentClass} text-black font-mono text-sm font-bold`}>
                      0{i + 1}
                    </span>
                  </div>
